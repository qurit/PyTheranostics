...
class BaseDosimetry(metaclass=abc.ABCMeta):
    ...
    def __init__(self,
        ...
        self.mass_and_s_values = {
            "100%/0%": {
                "tumor_mass": numpy.array([4.31E-03, 1.46E-02, 3.45E-02, 1.16E-01, 2.76E-01, 5.39E-01, 9.32E-01, 2.21E+00, 4.31E+00, 1.46E+01, 3.45E+01, 1.16E+02, 2.76E+02, 5.39E+02, 9.32E+02]),
                "total_s_value": numpy.array([4.54E-09, 1.44E-09, 6.29E-10, 1.93E-10, 8.26E-11, 4.27E-11, 2.49E-11, 1.06E-11, 5.46E-12, 1.63E-12, 6.93E-13, 2.07E-13, 8.81E-14, 4.54E-14, 2.65E-14])
            },
            "75%/25%": {
                "tumor_mass": numpy.array([5.26E-03, 1.77E-02, 4.21E-02, 1.42E-01, 3.36E-01, 6.57E-01, 1.14E+00, 2.69E+00, 5.26E+00, 1.77E+01, 4.21E+01, 1.42E+02, 3.36E+02, 6.57E+02, 1.14E+03]),
                "total_s_value": numpy.array([3.86E-09, 1.21E-09, 5.26E-10, 1.60E-10, 6.86E-11, 3.54E-11, 2.06E-11, 8.76E-12, 4.51E-12, 1.35E-12, 5.73E-13, 1.72E-13, 7.32E-14, 3.78E-14, 2.21E-14])  
            },
            "50%/50%": {
                "tumor_mass": numpy.array([6.20E-03, 2.09E-02, 4.96E-02, 1.67E-01, 3.97E-01, 7.75E-01, 1.34E+00, 3.17E+00, 6.20E+00, 2.09E+01, 4.96E+01, 1.67E+02, 3.97E+02, 7.75E+02, 1.34E+03]),
                "total_s_value": numpy.array([3.35E-09, 1.04E-09, 4.51E-10, 1.35E-10, 5.86E-11, 3.02E-11, 1.76E-11, 7.48E-12, 3.85E-12, 1.15E-12, 4.90E-13, 1.47E-13, 6.28E-14, 3.25E-14, 1.90E-14])
            },
            "25%/75%": {
                "tumor_mass": numpy.array([7.12E-03, 2.40E-02, 5.70E-02, 1.92E-01, 4.56E-01, 8.90E-01, 1.54E+00, 3.65E+00, 7.12E+00, 2.40E+01, 5.70E+01, 1.92E+02, 4.56E+02, 8.90E+02, 1.54E+03]),
                "total_s_value": numpy.array([2.97E-09, 9.18E-10, 3.96E-10, 1.20E-10, 5.11E-11, 2.64E-11, 1.53E-11, 6.52E-12, 3.36E-12, 1.01E-12, 4.28E-13, 1.29E-13, 5.51E-14, 2.86E-14, 1.67E-14])
            },
            "0%/100%": {
                "tumor_mass": numpy.array([8.04E-03, 2.71E-02, 6.43E-02, 2.17E-01, 5.15E-01, 1.01E+00, 1.74E+00, 4.12E+00, 8.04E+00, 2.71E+01, 6.43E+01, 2.17E+02, 5.15E+02, 1.01E+03, 1.74E+03]),
                "total_s_value": numpy.array([2.66E-09, 8.19E-10, 3.52E-10, 1.06E-10, 4.54E-11, 2.34E-11, 1.36E-11, 5.79E-12, 2.98E-12, 8.94E-13, 3.81E-13, 1.15E-13, 4.91E-14, 2.55E-14, 1.49E-14])
            }
        }
        ...
        for organ in organs:
            ...
            if self.config["rois"]["Kidney_Left"]["apply_biokinetics_from_previous_cycle"] == False:
                ...
                if kinetic == 'monoexp':
                    ...
                    mean_lambda_uptake = (self.config["rois"]['Kidney_Left']["fixed_parameters"][1] + self.config["rois"]['Kidney_Right']["fixed_parameters"][1]) / 2
                    t_washout = numpy.log(2) /  mean_lambda_washout
                    t_uptake = numpy.log(2) /  mean_lambda_uptake
                    bed[organ] = AD * (1 + (AD / (t_washout - t_uptake)) * (1 / alpha_beta) * (( (2 * t_repair**4 * (t_washout - t_uptake)) / ((t_repair**2 - t_washout**2) * (t_repair**2 - t_uptake**2)) ) + 
                                  ((2 * t_washout * t_uptake * t_repair) / (t_washout**2 - t_uptake**2) * (((t_washout)/(t_repair - t_washout)) + ((t_uptake) / (t_repair - t_uptake)))) - 
