from doodle.dosimetry import BaseDosimetry
...
class OrganSDosimetry(BaseDosimetry):
    def prepare_data(self):
        ...
        phrases_to_exclude.extend([f'L{i}' for i in range(10)])  
    ...
    def create_Olinda_file(self, dirname, savefile=False):
        ...
        for org in self.tiac_for_masks.index:  
            temporg = org
    ...
    def read_Olinda_results(self) -> None:
        pass 