...
def build_roi_fit_config(
    ...
    # Add WholeBody and RemainderOfBody if they are not available in masks, as they will be needed for dosimetry (and will be generated by default if not present)
    if "WholeBody" not in all_masks:
        all_masks.add("WholeBody")
    if "RemainderOfBody" not in all_masks:
        all_masks.add("RemainderOfBody")
