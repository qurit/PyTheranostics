...
def fetch_github_contributors(app):
    ...
    if not username or not repository:
        logger.warning("GitHub username or repository not configured. Skipping contributors fetch.")
        return
    ...
    for contributor in contributors:
        contributors_list.append(f"- {contributor['login']} (contributions: {contributor['contributions']})")
